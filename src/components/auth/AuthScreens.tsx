            ...
            >
              ...
              <form onSubmit={prepareRegister} className="space-y-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div className="relative group">
                  ...
                  <input
                    type="tel"
                    placeholder={t('auth_phone_placeholder', 'Phone Number (e.g. 0612345678)')}
                    value={phone}
                    onChange={(e) => {
                ...
                {role === 'artisan' && (
                  <>
                    ...
                    <div className="relative group">
                      ...
                      <input
                        type="text"
                        placeholder={t('auth_id_doc', 'ID Document URL')}
                        value={idDocument}
                        onChange={(e) => {
                ...
                <div className="space-y-3 px-2">
                  <p className="text-sm font-medium text-[var(--text-muted)] ml-2">{t('auth_verification_channel', 'Verification Channel')}</p>
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { id: 'sms', icon: Phone, label: t('auth_channel_sms', 'SMS') },
                      { id: 'email', icon: Mail, label: t('auth_channel_email', 'Email') }
                    ].map((ch) => (
                      <button
                        key={ch.id}
                        type="button"
